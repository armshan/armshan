...
{
    const bucketA =  'xltg-look';
    const bucketB =  'look-miniprogram';
    const bucketC =  'software-download';
    const bucketD =  'software-package';
    const bucketE =  'xltg-web';
    public static $BaiduBos;

    const BosConfig=[
            'credentials' =>
                    [
                        'accessKeyId' => 'bbf0f5240e3446bdbaf7dcddfb547369',
                        'secretAccessKey' => '27ee73d93ec545a38e851883e8161dd2',
